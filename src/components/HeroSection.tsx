...
const HeroSection = () => {
	return (
		<section className="w-full bg-white py-16 px-8">
			<div className="max-w-7xl mx-auto relative flex flex-col lg:flex-row items-center justify-center gap-8 lg:gap-0">
				...
				<div className="relative flex-shrink-0">
					<div
						...
						<h1
							className="text-white font-inter font-medium leading-none text-center text-3xl md:text-5xl lg:text-6xl xl:text-7xl tracking-tight"
